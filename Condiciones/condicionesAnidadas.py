...
pago = bool(True) #pago es una variable de tipo booleano

if (edad >= 18): #Si la edad es mayor o igual a 18,
    if (pago == True): #Si el pago es verdadero, entonces:
        print("Es mayor de edad y puede pasar") #Imprime: "Es mayor de edad y puede pasar"
    else: #Si el pago es falso, entonces:
        print("Es mayor de edad y no puede pasar") #Imprime: "Es mayor de edad y no puede pasar"
